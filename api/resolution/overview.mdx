...
| Contract | Address |
| --- | --- |
| Direct Resolution Oracle | `0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F` |
| Standard DRO CTF Adapter | `0xF5d85546573eD5400C623b0ad18391b05f4e8CD7` |
| Neg-risk DRO CTF Adapter | `0xeDA095874A3f2827d240d560616Bb814C91C1781` |
| Neg-risk Operator | `0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e` |
...
| `DRO_ORACLE_ADDRESS` | No | Defaults to `0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F`. |
| `NEG_RISK_OPERATOR_ADDRESS` | No | Defaults to `0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e`. |
...
const DRO_ORACLE_ADDRESS = (process.env.DRO_ORACLE_ADDRESS ??
  "0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F") as `0x${string}`;
const NEG_RISK_OPERATOR_ADDRESS = (process.env.NEG_RISK_OPERATOR_ADDRESS ??
  "0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e") as `0x${string}`;
...
const DRO_ORACLE_ADDRESS = process.env.DRO_ORACLE_ADDRESS ??
  "0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F";
const NEG_RISK_OPERATOR_ADDRESS = process.env.NEG_RISK_OPERATOR_ADDRESS ??
  "0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e";
...
DRO_ORACLE_ADDRESS = os.getenv("DRO_ORACLE_ADDRESS", "0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F")
NEG_RISK_OPERATOR_ADDRESS = os.getenv("NEG_RISK_OPERATOR_ADDRESS", "0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e")
...
func main() {
	...
	oracleAddress := common.HexToAddress(env("DRO_ORACLE_ADDRESS", "0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F"))
	negRiskOperatorAddress := common.HexToAddress(env("NEG_RISK_OPERATOR_ADDRESS", "0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e"))
...
async fn main() -> eyre::Result<()> {
    ...
    let oracle_address: Address = env_or("DRO_ORACLE_ADDRESS", "0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F").parse()?;
    let neg_risk_operator_address: Address =
        env_or("NEG_RISK_OPERATOR_ADDRESS", "0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e").parse()?;
...
$droOracle = getenv("DRO_ORACLE_ADDRESS") ?: "0x80eA8191033f431F8cC2F7d6Fb2b2CCe4ddAFD5F";
$negRiskOperator = getenv("NEG_RISK_OPERATOR_ADDRESS") ?: "0xF8cFEe0849F80bcBdb33A365096eC4ff8b14218e";
