...
For the operator-facing incentive model, bonded user reports, fee split, and Security Reserve, see [DRO Resolution & Rewards](/api/resolution/rewards).

<Frame>
  <img
    className="block dark:hidden"
    src="/images/dro-resolution-flow.svg"
    alt="DRO resolution flow from market rules and proposer validation through the on-chain resolution transaction and platform synchronization"
  />
  <img
    className="hidden dark:block"
    src="/images/dark/dro-resolution-flow.svg"
    alt="DRO resolution flow from market rules and proposer validation through the on-chain resolution transaction and platform synchronization"
  />
</Frame>
...
| Standard DRO CTF Adapter | `0xc97c5aa5180731c7bB741Fc9B3c293272ca8d33D` |
| Neg-risk DRO CTF Adapter | `0x31719d442A5F461c4F021A39270820821e17FF93` |
| Neg-risk Operator | `0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f` |
...
| `DRO_ORACLE_ADDRESS` | No | Defaults to `0x57827d48Da09ba227aFda89C083b4E35972Aa741`. |
| `NEG_RISK_OPERATOR_ADDRESS` | No | Defaults to `0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f`. |
...
const DRO_ORACLE_ADDRESS = (process.env.DRO_ORACLE_ADDRESS ??
  "0x57827d48Da09ba227aFda89C083b4E35972Aa741") as `0x${string}`;
const NEG_RISK_OPERATOR_ADDRESS = (process.env.NEG_RISK_OPERATOR_ADDRESS ??
  "0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f") as `0x${string}`;
...
const DRO_ORACLE_ADDRESS = process.env.DRO_ORACLE_ADDRESS ??
  "0x57827d48Da09ba227aFda89C083b4E35972Aa741";
const NEG_RISK_OPERATOR_ADDRESS = process.env.NEG_RISK_OPERATOR_ADDRESS ??
  "0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f";
...
DRO_ORACLE_ADDRESS = os.getenv("DRO_ORACLE_ADDRESS", "0x57827d48Da09ba227aFda89C083b4E35972Aa741")
NEG_RISK_OPERATOR_ADDRESS = os.getenv("NEG_RISK_OPERATOR_ADDRESS", "0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f")
...
func main() {
	...
	oracleAddress := common.HexToAddress(env("DRO_ORACLE_ADDRESS", "0x57827d48Da09ba227aFda89C083b4E35972Aa741"))
	negRiskOperatorAddress := common.HexToAddress(env("NEG_RISK_OPERATOR_ADDRESS", "0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f"))
...
async fn main() -> eyre::Result<()> {
    ...
    let oracle_address: Address = env_or("DRO_ORACLE_ADDRESS", "0x57827d48Da09ba227aFda89C083b4E35972Aa741").parse()?;
    let neg_risk_operator_address: Address =
        env_or("NEG_RISK_OPERATOR_ADDRESS", "0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f").parse()?;
...
$droOracle = getenv("DRO_ORACLE_ADDRESS") ?: "0x57827d48Da09ba227aFda89C083b4E35972Aa741";
$negRiskOperator = getenv("NEG_RISK_OPERATOR_ADDRESS") ?: "0xdc3c1B4288A107973aDe490CB07BdFD4CF1D376f";
