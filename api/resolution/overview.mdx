...
<Steps>
  ...
  <Step title="Wait for sync">
    After the transaction confirms, the protected resolution sync job reads the resolution subgraph and updates market status, outcome payouts, caches, and event state.
  </Step>
</Steps>
