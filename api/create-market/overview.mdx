...
<Frame>
  <img
    ...
    src="/images/create-market-lifecycle.svg"
    alt="Create Market API lifecycle from runtime configuration and creator authorization through transactions and final registration"
  />
  <img
    className="hidden dark:block"
    src="/images/dark/create-market-lifecycle.svg"
    alt="Create Market API lifecycle from runtime configuration and creator authorization through transactions and final registration"
  />
</Frame>
...
<AccordionGroup>
  <Accordion title="Preparation requires creator consent" icon="signature" defaultOpen>
