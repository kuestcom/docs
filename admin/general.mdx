---
title: General
description: Configure the brand, market context, featured markets, synced sources, and legal controls in Admin -> General.
icon: settings
---

<Info>
Start here after deployment. Configure the public brand and support details first, then review discovery, market context, creator sources, and legal controls.
</Info>
