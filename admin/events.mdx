...
Use this page to operate existing events and to create new ones. Visibility, context, sports data, sync policy, and settlement readiness all meet here.

<CardGroup cols={3}>
  <Card title="Review" icon="clipboard-list">
    Find events by category, creator, series, status, or operational attention.
  </Card>
  <Card title="Operate" icon="settings-2">
    Manage visibility, context, livestreams, source matching, and sync behavior.
  </Card>
  <Card title="Create" icon="square-plus" href="#create-event">
    Build and sign a new event through the calendar workflow.
  </Card>
</CardGroup>

<AccordionGroup>
  <Accordion title="Table and filters" icon="list-filter" defaultOpen>
...
<AccordionGroup>
  <Accordion title="Auth challenge" icon="key-round" defaultOpen>
  ...
  <Accordion title="Finalize" icon="circle-check-big">
