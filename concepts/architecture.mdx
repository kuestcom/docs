...
<AccordionGroup>
  ...
  <Accordion title="Uploaded assets" icon="images">
    Logos, event images, and market covers live in the Supabase or S3-compatible storage profile you configure. Terms of Service translations are stored in your PostgreSQL database.
  </Accordion>
