...
| `/api/sync/translations/enqueue` | `3,12,21,30,39,48,57 * * * *` | Enqueues translation jobs seven times per hour |
| `/api/sync/translations` | `4,13,22,31,40,49,58 * * * *` | Processes translation jobs one minute after enqueue runs |
